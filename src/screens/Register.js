      ...
      <View style={styles.container}>
        ...
        <View style={styles.logo}>
          ...
          <View style={styles.textFields}>
              ...
              <Textfield source={require('../../assets/password.png')} placeholder={'Confirm Password'} secureTextEntry={true} maxLength={15}/>
            ...
            <View style={{flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 20}}>
              <Text style={{color: '#FFFFFF', marginRight: 5, fontFamily: 'JosefinSans-Regular', fontSize: 17}}>Already have an account?</Text>
              <TouchableOpacity>
                <Text style={{fontWeight: '600', color: '#5663FF', fontFamily: 'JosefinSans-Regular', fontSize: 17}}>Login</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
